...
Support for `[[Internal Link]]` syntax.

- Link to Home: [[/]]
- Link to Games: [[/games]]
- Link with text: [[/games/tetris|Play Tetris]]
- Link to a file: [[/README|README]]
- Link to a file: [[/example/obsidian-demo]]
...
Support for Callouts (mapped to GitHub Alerts).
